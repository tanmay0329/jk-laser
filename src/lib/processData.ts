export const processData = [
  {
    ...
    features: [
      "Extensive catalog of modern and traditional patterns",
      "One-on-one consultation with design experts",
      "Feasibility and structural integrity analysis",
      "Material recommendation tailored to your design"
    ],
    heroImage: "https://images.unsplash.com/photo-1600607688969-a5bfcd646154?q=80&w=2000&auto=format&fit=crop",
    iconName: "PenTool",
    nextSlug: "cad-drawing"
  },
  {
    id: "02",
    slug: "cad-drawing",
    ...
    features: [
      "Millimeter-precision 2D/3D modeling",
      "Structural load and tolerance testing",
      "Client approval cycles before production",
    ...
    iconName: "Laptop",
    prevSlug: "design-selection",
    nextSlug: "laser-cutting"
  },
  {
    id: "03",
    slug: "laser-cutting",
    ...
    features: [
      "Zero-tolerance precision cutting",
      "Clean, burr-free edges on all metals",
      "Capability to cut up to thick metal plates",
      "Highly efficient and rapid production times"
    ],
    heroImage: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c?q=80&w=2000&auto=format&fit=crop",
    iconName: "Cpu",
    prevSlug: "cad-drawing",
    nextSlug: "finishing"
  },
  {
    id: "04",
    ...
    features: [
      ...
      "Weather-resistant anti-rust treatments",
      "Premium powder coating and PU painting",
      "Custom color matching and metallic finishes"
    ],
    heroImage: "https://images.unsplash.com/photo-1544457070-4cd773b4d71e?q=80&w=2000&auto=format&fit=crop",
    iconName: "SprayCan",
    prevSlug: "laser-cutting",
  ...
  },
  {
    ...
    features: [
      "Expert on-site assembly and mounting",
      "Secure structural anchoring",
      "Clean and professional work ethic",
      "Final on-site polish and handover"
    ],
